...
public class WiFiDirectActivity extends AppCompatActivity
  ...
  public void connectToAccessPoint(String ssid, String passphrase) {
    ...
    Log.d(WiFiDirectActivity.TAG,
        "Connected? ip = " + wifiManager.getConnectionInfo().getIpAddress());
    Log.d(WiFiDirectActivity.TAG,
        "Connected? bssid = " + wifiManager.getConnectionInfo().getBSSID());
    ...
    if (wifiManager.getConnectionInfo().getIpAddress() != 0) {
      ...
      Toast.makeText(this, "WiFi AP connection failed... ip = "
