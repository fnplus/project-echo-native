 ...
 */
@SuppressLint("ValidFragment") public class PromptPasswordFragment extends DialogFragment {
  ...
  @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    ((TextView) mContentView.findViewById(R.id.ssid)).setText(
        "Enter password for (" + this.ssid + ")");
    ...
    builder.setView(mContentView)
        ...
        .setPositiveButton(R.string.label_connect, new DialogInterface.OnClickListener() {
          ...
          @Override public void onClick(DialogInterface dialog, int id) {
            ...
            String password = ((TextView) PromptPasswordFragment.this.mContentView.findViewById(
