 ...
 */
public class AllEncompassingP2PClient {
   ...
   * Constructor
   */
  public AllEncompassingP2PClient(String mac_address, String ip, String name, String groupOwner) {
   ...
   */
  public static AllEncompassingP2PClient fromString(String serialized) {
    String[] divided = serialized.split(",");
    return new AllEncompassingP2PClient(divided[1], divided[0], divided[2], divided[3]);
  }
}
